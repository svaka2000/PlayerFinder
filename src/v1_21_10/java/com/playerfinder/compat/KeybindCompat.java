...
/** 1.21.10 keybind builder: the category is a {@link KeyMapping.Category} object — our own registered
...
public final class KeybindCompat {
    ...
    private static KeyMapping.Category registerCategory() {
        try {
            return KeyMapping.Category.register(ResourceLocation.fromNamespaceAndPath("playerfinder", "general"));
        } catch (Throwable t) {
